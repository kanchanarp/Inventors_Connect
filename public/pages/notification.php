                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="alert alert-success alert-dismissable">
                                ...
                                Notification 01. <a href="#" class="alert-link">Activity Alert</a>.
                            </div>
                            <div class="alert alert-info alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                Notification 02. <a href="#" class="alert-link">Activity Alert</a>.
                            </div>
                            <div class="alert alert-warning alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                Notification 03. <a href="#" class="alert-link">Activity Alert</a>.
                            </div>
                            <div class="alert alert-danger alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                Notification 04. <a href="#" class="alert-link">Activity Alert</a>.
                            </div>
                        </div>
                        <!-- .panel-body -->
                    </div>
